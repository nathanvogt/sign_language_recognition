...
if __name__ == "__main__":
    ...
    config_file = os.path.join(
        root, "code/TGCN/archived/{}/{}.ini".format(trained_on, trained_on)
    )
    ...
    checkpoint = torch.load(
        os.path.join(root, "code/TGCN/archived/{}/{}".format(trained_on, checkpoint))
    )
